...
public class ConfirmFinalOrder extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(getApplicationContext(), "Total is KES " +totalAmount, Toast.LENGTH_LONG).show();

        confirmOrderBtn = findViewById(R.id.confirm_final_order_btn);
        nameEditText = findViewById(R.id.shipment_name);
        phoneEditText = findViewById(R.id.shippmement_phone_number);
        addressEditText = findViewById(R.id.shippmement_adress);
        cityEditText = findViewById(R.id.shippmement_city);
    ...
    private void Check() {
        ...
        if (TextUtils.isEmpty(nameEditText.getText().toString())){
            Toast.makeText(getApplicationContext(), "Please Provide Your Full Names.", Toast.LENGTH_LONG).show();
        }
            ...
            Toast.makeText(getApplicationContext(), "Please Provide Your City Name.", Toast.LENGTH_LONG).show();
        } else {
