...
import com.eshop.R;
import com.eshop.model.AdminOrders;
         ...
         FirebaseRecyclerAdapter<AdminOrders, AdminOrdersViewHolder > adapter =
                 new FirebaseRecyclerAdapter<AdminOrders, AdminOrdersViewHolder>(options) {
                     ...
                     protected void onBindViewHolder(@NonNull AdminOrdersViewHolder holder, int i, @NonNull AdminOrders adminOrders) {
                         ...
                         holder.userTotalPrice.setText("Total Amount = Kes : " +adminOrders.getTotalAmount());
                         holder.userDataTime.setText("Order at: " +adminOrders.getDate()+" "+adminOrders.getTime());
